...
MODERATION_VALUES_FOR_BLOCKED = {
    "harassment": 1.0, #0.5
    "harassment/threatening": 1.0, #0.1,
    "hate": 1.0, #0.5
    "hate/threatening": 1.0, #0.1,
    "self-harm": 1.0, #0.2,
    "self-harm/instructions": 1.0, #0.5,
    "self-harm/intent": 1.0, #0.7,
    "sexual": 1.0, #0.5,
    "sexual/minors": 1.0, #0.2,
    "violence": 1.0, #0.7,
    "violence/graphic": 1.0, #0.8,
}
